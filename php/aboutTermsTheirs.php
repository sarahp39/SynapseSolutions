<?php
	...
	<div id = "TermsofUse">
		...
		<p>Welcome to Synapse Solutions™, a platform service (the “Synapse Solution Services”) 
		for anyone to easily upload, clean and manipulate electroencephalogram (EEG) data. 
		...
		<p>The AppSheet service asks for and stores some of your personal contact information, 
